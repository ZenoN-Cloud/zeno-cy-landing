  ...
  return (
    <div className="relative overflow-hidden bg-transparent">
      <div className="absolute inset-0 opacity-20 md:opacity-30">
        <div className="absolute -top-24 left-1/3 h-64 w-64 md:h-96 md:w-96 rounded-full bg-lime-300 blur-[60px] md:blur-[180px]" />
        <div className="absolute top-1/4 -right-20 h-64 w-64 md:h-[28rem] md:w-[28rem] rounded-full bg-emerald-400 blur-[80px] md:blur-[220px]" />
      </div>
